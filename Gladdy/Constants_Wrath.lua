...
local cooldownList = {
    ...
    ["DRUID"] = {
        ...
        [16979] = { cd = 15, spec = L["Restoration"], }, -- Feral Charge
    ...
    ["NightElf"] = {
        [2651] = { cd = 180, class = "PRIEST"}, -- Elune's Grace
        [10797] = { cd = 30, class = "PRIEST"}, -- Star Shards
    },
    ["Draenei"] = {
        [32548] = { cd = 300, class = "PRIEST"}, -- Hymn of Hope
    },
    ["Human"] = {
        [13908] = { cd = 600, class = "PRIEST"}, -- Desperate Prayer
    },
    ["Gnome"] = {
    },
    ["Dwarf"] = {
        [13908] = { cd = 600, class = "PRIEST"}, -- Desperate Prayer
        [44047] = { cd = 30, class = "PRIEST"}, -- Chastise
    },
}
...
local totemDataShared, totemNpcIdsToTotemDataShared = Gladdy:GetSharedTotemData()
